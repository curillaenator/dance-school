...
export const SOCIAL_ICONS_ASSOC: Record<Exclude<ContactsType, 'tels' | 'email'>, JSX.Element> = {
  telegram: <TelegramIcon color='primary' />,
...
export const NON_SOCIAL_ICONS_ASSOC: Record<Extract<ContactsType, 'tels' | 'email'>, JSX.Element> = {
  tels: <PhoneIcon color='primary' />,
